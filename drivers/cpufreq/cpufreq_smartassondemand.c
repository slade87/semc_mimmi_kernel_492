...
#ifndef CONFIG_CPU_FREQ_SMARTASS_GOV_ONDEMAND
static
#endif
struct cpufreq_governor cpufreq_gov_smartass_ondemand = {
	.name			= "smartondemand",
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	err = cpufreq_register_governor(&cpufreq_gov_smartass_ondemand);
	if (err)
...
{
	cpufreq_unregister_governor(&cpufreq_gov_smartass_ondemand);
	destroy_workqueue(kondemand_wq);
}
...
#ifdef CONFIG_CPU_FREQ_SMARTASS_GOV_ONDEMAND
